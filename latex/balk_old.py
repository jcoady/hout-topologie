...
def construct(x0,y0,z0,l,w,h,xa,ya,za):
   ...
   H |   |        /               | /  /|
    ...
    rand1.rotate(angle=xa,axis=vector(1,0,0),origin=vector(x0,y0,z0))
    rand1.rotate(angle=ya,axis=vector(0,1,0),origin=vector(x0,y0,z0))
    rand1.rotate(angle=za,axis=vector(0,0,1),origin=vector(x0,y0,z0))
    
    d1,d2,d3=s(p3,p2)
    rand2 =  cylinder(pos=vector(p2[0],p2[1],p2[2]),         axis=vector(d1,d2,d3), radius=.1,color=vector(0,0,0))
    rand2.rotate(angle=xa,axis=vector(1,0,0),origin=vector(x0,y0,z0))
    rand2.rotate(angle=ya,axis=vector(0,1,0),origin=vector(x0,y0,z0))
    rand2.rotate(angle=za,axis=vector(0,0,1),origin=vector(x0,y0,z0))
    
    d1,d2,d3=s(p4,p3)
    rand3 =  cylinder(pos=vector(p3[0],p3[1],p3[2]),         axis=vector(d1,d2,d3), radius=.1,color=vector(0,0,0))
    rand3.rotate(angle=xa,axis=vector(1,0,0),origin=vector(x0,y0,z0))
    rand3.rotate(angle=ya,axis=vector(0,1,0),origin=vector(x0,y0,z0))
    rand3.rotate(angle=za,axis=vector(0,0,1),origin=vector(x0,y0,z0))
    
    d1,d2,d3=s(p4,p1)
    rand4 =  cylinder(pos=vector(p1[0],p1[1],p1[2]),         axis=vector(d1,d2,d3), radius=.1,color=vector(0,0,0))
    rand4.rotate(angle=xa,axis=vector(1,0,0),origin=vector(x0,y0,z0))
    rand4.rotate(angle=ya,axis=vector(0,1,0),origin=vector(x0,y0,z0))
    rand4.rotate(angle=za,axis=vector(0,0,1),origin=vector(x0,y0,z0))
    
    d1,d2,d3=s(p6,p5)
    rand5 =  cylinder(pos=vector(p5[0],p5[1],p5[2]),         axis=vector(d1,d2,d3), radius=.1,color=vector(0,0,0))
    rand5.rotate(angle=xa,axis=vector(1,0,0),origin=vector(x0,y0,z0))
    rand5.rotate(angle=ya,axis=vector(0,1,0),origin=vector(x0,y0,z0))
    rand5.rotate(angle=za,axis=vector(0,0,1),origin=vector(x0,y0,z0))
    
    d1,d2,d3=s(p7,p6)
    rand6 =  cylinder(pos=vector(p6[0],p6[1],p6[2]),         axis=vector(d1,d2,d3), radius=.1,color=vector(0,0,0))
    rand6.rotate(angle=xa,axis=vector(1,0,0),origin=vector(x0,y0,z0))
    rand6.rotate(angle=ya,axis=vector(0,1,0),origin=vector(x0,y0,z0))
    rand6.rotate(angle=za,axis=vector(0,0,1),origin=vector(x0,y0,z0))
    
    d1,d2,d3=s(p8,p7)
    rand7 =  cylinder(pos=vector(p7[0],p7[1],p7[2]),         axis=vector(d1,d2,d3), radius=.1,color=vector(0,0,0))
    rand7.rotate(angle=xa,axis=vector(1,0,0),origin=vector(x0,y0,z0))
    rand7.rotate(angle=ya,axis=vector(0,1,0),origin=vector(x0,y0,z0))
    rand7.rotate(angle=za,axis=vector(0,0,1),origin=vector(x0,y0,z0))
    
    d1,d2,d3=s(p5,p8)
    rand8 =  cylinder(pos=vector(p8[0],p8[1],p8[2]),         axis=vector(d1,d2,d3), radius=.1,color=vector(0,0,0))
    rand8.rotate(angle=xa,axis=vector(1,0,0),origin=vector(x0,y0,z0))
    rand8.rotate(angle=ya,axis=vector(0,1,0),origin=vector(x0,y0,z0))
    rand8.rotate(angle=za,axis=vector(0,0,1),origin=vector(x0,y0,z0))
    
    d1,d2,d3=s(p5,p1)
    rand9 =  cylinder(pos=vector(p1[0],p1[1],p1[2]),         axis=vector(d1,d2,d3), radius=.1,color=vector(0,0,0))
    rand9.rotate(angle=xa,axis=vector(1,0,0),origin=vector(x0,y0,z0))
    rand9.rotate(angle=ya,axis=vector(0,1,0),origin=vector(x0,y0,z0))
    rand9.rotate(angle=za,axis=vector(0,0,1),origin=vector(x0,y0,z0))
    
    d1,d2,d3=s(p6,p2)
    rand10 = cylinder(pos=vector(p2[0],p2[1],p2[2]),         axis=vector(d1,d2,d3), radius=.1,color=vector(0,0,0))
    rand10.rotate(angle=xa,axis=vector(1,0,0),origin=vector(x0,y0,z0))
    rand10.rotate(angle=ya,axis=vector(0,1,0),origin=vector(x0,y0,z0))
    rand10.rotate(angle=za,axis=vector(0,0,1),origin=vector(x0,y0,z0))
    
    d1,d2,d3=s(p7,p3)
    rand11 = cylinder(pos=vector(p3[0],p3[1],p3[2]),         axis=vector(d1,d2,d3), radius=.1,color=vector(0,0,0))
    rand11.rotate(angle=xa,axis=vector(1,0,0),origin=vector(x0,y0,z0))
    rand11.rotate(angle=ya,axis=vector(0,1,0),origin=vector(x0,y0,z0))
    rand11.rotate(angle=za,axis=vector(0,0,1),origin=vector(x0,y0,z0))
